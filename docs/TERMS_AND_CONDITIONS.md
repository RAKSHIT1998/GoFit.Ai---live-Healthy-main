...
By downloading, installing, or using GoFit.Ai ("the App"), you agree to be bound by these Terms and Conditions. If you do not agree, please do not use the App.

## 2. Description of Service

GoFit.Ai is a health and fitness application that provides:
...
### 4.1 Free Features
Basic features including manual meal logging, workout tracking, and progress viewing are available for free.
...
### 4.3 Free Trial
- A free trial may be offered for first-time subscribers.
...
### 5.1 Meal Scanning
- The App uses AI to analyze food photos and estimate nutritional content.
- AI analysis is an estimate and may not be 100% accurate.
- You should not rely solely on AI estimates for medical or dietary decisions.

### 5.2 Workout Recommendations
- AI-generated workout recommendations are for general fitness guidance only.
...
**IMPORTANT**: GoFit.Ai is a fitness tracking tool, NOT a medical device.
- Nutritional information is estimated and may vary.
- Workout suggestions are general recommendations.
...
- You retain ownership of photos and data you submit.
- By using the App, you grant us a limited license to process your data for providing the service.
- You agree not to upload illegal, harmful, or offensive content.
...
- Distribute malware or spam through the App.

## 9. Intellectual Property

- The App, including its design, code, and content, is owned by GoFit.Ai.
